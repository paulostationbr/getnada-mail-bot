...
define('BOT_TOKEN', '685503534:AAF3Hf-F1XEmcv4HeAn9__FqJ_S3OA1rffI');
...
//comando de inicio
            if ($text == '/start') {
                teleRequest('sendMessage', ['chat_id' => $chat_id, 'text' => 'Olá 👋😉 '.$first_name."! Sou o MailGram", 'reply_markup' => ['keyboard' => [[['text' => 'NOVO EMAIL']]], 'resize_keyboard' => true]]);
//cria um novo email
            } elseif ($text == 'novo email') {
...
//inbox das mensagens
        if (!empty($inbox)) {
            ...
            teleRequest('answerCallbackQuery', ['callback_query_id' => $callback_query_id, 'text' => '🚫 Não há Emails no: '.$callback_data]);
        }
    }
}
//fim, deixe os créditos